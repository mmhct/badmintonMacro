...
def detect_color(block, target_color, threshold=50):
    # 转换目标颜色从RGB到BGR
...
def run_if_still_verifying():
    # start = time.time()
    screen = screen_capture()
    # 找出屏幕截图“加载中”显示的块
    blocks = screen[637:660, 1506:1528]  # 这个laptop也适用
    ...
    target_color = (51, 51, 51)  # 偏黑色，laptop识别完全准确

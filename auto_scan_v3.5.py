...
def perform_task(have,iter):
    ...
    if (detection_results[14] and detection_results[17]) and (14 not in have and 15 not in have and 16 not in have and 17 not in have):
        ...
        have.append(16)
        have.append(17)
    elif (detection_results[15] and detection_results[18]) and (15 not in have and 16 not in have and 17 not in have and 18 not in have):
        ...
        have.append(17)
        have.append(18)
    elif (detection_results[16] and detection_results[19]) and (16 not in have and 17 not in have and 18 not in have and 19 not in have):
        ...
        have.append(18)
        have.append(19)
    elif (detection_results[12] and detection_results[15]) and (12 not in have and 13 not in have and 14 not in have and 15 not in have):
        ...
        have.append(14)
        have.append(15)
    elif (detection_results[13] and detection_results[16]) and (13 not in have and 14 not in have and 15 not in have and 16 not in have):
        ...
        have.append(15)
        have.append(16)
    elif (detection_results[3] and detection_results[6]) and (3 not in have and 4 not in have and 5 not in have and 6 not in have):
